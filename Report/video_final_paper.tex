...
\begin{thebibliography}{11}
    \bibitem{b1} M. R. Halvorsen, “Content-based lecture video indexing,” Master’s thesis ,2007.
    \bibitem{b2} W. Zhang, Chapter 8, “Multimedia Technology, Education and Learning”, Technological Innovations in Literacy and Social Studies Education [online], 1995. Available: http://tiger.core.missouri.edu 
    \bibitem{b3} NPTEL (National Programme on Technology Enhanced Learning), http://nptel.iitm.ac.in
	\bibitem{b4} https://docs.python.org/3/library/difflib.html
	\bibitem{b5} https://web.stanford.edu/~jurafsky/slp3/3.pdf
	\bibitem{b6} https://www.nltk.org/book1ed/ch05.html
	\bibitem{b7} https://spacy.io/models
	\bibitem{b8} https://www.nltk.org/book/ch03.html
	\bibitem{b9} http://faculty.washington.edu/yenchic/17Sp403/Lec7-density.pdf
	\bibitem{b10} Covington, P.; Adams, J.; Sargin, E. Deep neural networks for youtube recommendations. In Proceedings of the 10th ACM Conference on Recommender Systems, New York, NY, USA, 7 September 2016; pp. 191–198.
\end{thebibliography}
